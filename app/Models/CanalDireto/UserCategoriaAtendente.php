...
class UserCategoriaAtendente extends Model
{
    /**
    ...
    */
    protected $table = 'cd.USER_CATEGORIA_ATENDENTES';
     ...
     */
    public $collection = "\App\Http\Resources\UserCategoriaAtendente::collection";

    /**
     * <b>resource</b>
     */
    public $resource = "\App\Http\Resources\UserCategoriaAtendente";
